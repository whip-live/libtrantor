...
def test_parse():
    ...
    expected_data_1 = {
        ...
        'tdop': 1, 'temperature': 4, 'timestamp': datetime.fromtimestamp(16777472), 'vdop': 2}
    expected_data_2 = {
        ...
        'timestamp': datetime.fromtimestamp(0), 'vdop': 0}
...
def test_both():
    ...
    data = {
        ...
        'tdop': 45, 'temperature': 12, 'timestamp': datetime.fromtimestamp(1677747.2), 'vdop': 2}
    binary = build(**data)
